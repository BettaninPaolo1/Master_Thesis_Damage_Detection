...
# Output folder
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_nuts_bridge_stats") 
...
if __name__ == "__main__":
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_01_cm_mean.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_02_reg_mode.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_03_reg_mean.png")); plt.close()
    ...
    plt.legend(); plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_04_error_comp.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_05_vae_shift.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_06_calibration.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_07_unc_boxplot.png")); plt.close()
    ...
    plt.tight_layout(); plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_08_unc_class.png")); plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_09_rhat_boxplot.png"))
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_DIR, "nuts_bridge_10_mae_per_class.png"))
    plt.close()
