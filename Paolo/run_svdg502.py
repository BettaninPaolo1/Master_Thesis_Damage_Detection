...
RESULTS_DIR = os.path.join(SCRIPT_DIR, "results_svgd502_stats7_swish")
...
def calculate_mode_vector(particles, lower=0.0, upper=0.55):
    """Calcola la moda per ogni classe usando KDE."""
...
def evaluate_metrics(results_df):
    """Funzione di valutazione interna (compatibilità col file precedente)."""
    print("\n" + "="*80)
    ...
    # Adattato per leggere le nuove chiavi standardizzate
    ...
    # Plot Confusion Matrix (Solo su Mode)
...
if __name__ == "__main__":
    ...
    for i, idx in enumerate(indices):
        ...
        try:
            ...
            # Calcola lo spostamento medio totale
            ...
            # --- DIZIONARIO COMPLETO (Standardizzato) ---
            row_data = {
                "Index": idx,
                "True_Class": true_cls,
